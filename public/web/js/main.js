(function ($) {
    ...
    /* news-feed-active */
    console.log($('.news-feed-active'));
    $('.news-feed-active').owlCarousel({
        loop: true,
        navText: ['<i class="fa fa-angle-left"></i>', '<i class="fa fa-angle-right"></i>'],
        nav: true,
        autoplay: true,
    ...
    /* event-active */
    $('.brand-logo-activee').owlCarousel({
        loop: true,
        navText: ['<i class="fa fa-angle-left"></i>', '<i class="fa fa-angle-right"></i>'],
        nav: true,
        autoplay: true,
