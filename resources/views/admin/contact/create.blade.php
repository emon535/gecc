    ...
    <div class="col-xs-12">
        <div class="widget-box">
            <div class="widget-header widget-header-blue widget-header-flat">
                ...
                <h4 class="widget-title lighter">Create Office Address</h4>
            </div>
                ...
                <div class="widget-main">
                    <div class="step-content pos-rel" id="step-container">
                        <div class="step-pane active" id="step1">
                            ...
                            <form class="form-horizontal" action="{{ url('store-office-address') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        <div class="clearfix">
                                            <input type="text" name="office_location" class="col-xs-12 col-sm-4" value="{{ old('office_location') }}" required />
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        <div class="clearfix">
                                            <input type="text" name="code" placeholder="Country Iso Code" class="col-xs-12 col-sm-4" value="{{ old('code') }}" required />
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        <div class="clearfix">
                                            <input type="text" name="region_name" placeholder="Region name" class="col-xs-12 col-sm-4" value="{{ old('region_name') }}" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        <div class="clearfix">
                                            <input type="email" name="email" placeholder="Enter Email Address" class="col-xs-12 col-sm-4" value="{{ old('email') }}" required />
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        <div class="clearfix">
                                            <input type="text" name="phone" placeholder="Enter Phone Number" class="col-xs-12 col-sm-4" value="{{ old('phone') }}" required />
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        <div class="clearfix">
                                            <textarea name="office_address" cols="25" rows="5" id="office_address" class="col-xs-12 col-sm-4" required>{{ old('office_address') }}</textarea>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        <div class="clearfix">
                                            <textarea name="map" id="" cols="30" rows="4" class="form-control" required>{!! old('map') !!}</textarea>
                                        </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-xs-12 col-sm-9">
                                        <div class="clearfix">
                                            <input class="form-check-input" name="is_default" type="checkbox" value="1" id="defaultCheck1" {{ old('is_default') == 1 ? 'checked' : null }} >
                                        </div>
                                    </div>
                                </div>
