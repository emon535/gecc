            ...
            <div class="col-md-5 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::open(['url' => 'updateRole', 'method' => 'POST']) !!}
                            
                            <div class="form-group row">
                                <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Role Name <span style="color: red;font-size: 15px;">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="role_name" value="{{ $selectedRole->role_name }}" class="form-control" placeholder="Enter Role Name" required>

                                    <input type="hidden" name="id" value="{{ $selectedRole->id }}" class="form-control">
                                </div>
                            </div>
