		...
		<div class="col-xs-12">
			<div class="table-header">
				...
				<span class="add-new-record">
					...
					<a class="white" href="{{ url('add-study-option') }}">
						Add New Record
					</a>
				</span>
			</div>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td class="center">
									<a class="green" data-rel="tooltip" data-placement="bottom" title="Edit" href="{{ url('edit-study-option/'.$value->id)}}">
										<i class="ace-icon fa fa-pencil bigger-120"></i>
									</a> | 
									<a class="red delete" data-rel="tooltip" data-placement="bottom" title="Delete" href="{{ url('delete-study-option/'.$value->id) }}">
